...
func NewEventSystem(sys *FilterSystem) *EventSystem {
	...
	if m.txsSub == nil || m.queuedTxsSub == nil || m.logsSub == nil || m.logsAcceptedSub == nil || m.rmLogsSub == nil || m.chainSub == nil || m.chainAcceptedSub == nil || m.pendingLogsSub == nil || m.txsAcceptedSub == nil {
